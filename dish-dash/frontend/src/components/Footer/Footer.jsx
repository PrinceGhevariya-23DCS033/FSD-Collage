...
const Footer = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(
      `Thanks for subscribing! We appreciate your interest And We will sent the notification to ${email} when we have new offers. Stay tuned!`
    );
    setEmail('');
  };
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="border-t border-amber-800 pt-8 mt-8 text-center">
          ...
          <div className="group inline-block">
            <a
              href="https://api.whatsapp.com/send?phone=919924484383"
              target="_blank"
              rel="noopener noreferrer"
